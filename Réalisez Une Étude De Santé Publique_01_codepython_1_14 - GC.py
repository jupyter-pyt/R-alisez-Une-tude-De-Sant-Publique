...
df_dispo_alim_fr_animaux = pd.read_csv(
    r'/content/fr_animaux.csv')
df_dispo_alim_fr_vegetaux = pd.read_csv(
    r'/content/fr_vegetaux.csv')
...
df_vegetaux = pd.read_csv(r'/content/fr_vegetaux.csv')
...
df_animaux = pd.read_csv(r'/content/fr_animaux.csv')
...
df_sousalimentation = pd.read_csv(r'/content/fr_sousalimentation.csv')
...
print("""
      """)
df_cereales = pd.read_csv(r'/content/fr_céréales.csv')
